...
import static trycodec.SimpleTextDocValuesWriter.END;
import static trycodec.SimpleTextDocValuesWriter.FIELD;
import static trycodec.SimpleTextDocValuesWriter.LENGTH;
import static trycodec.SimpleTextDocValuesWriter.MAXLENGTH;
import static trycodec.SimpleTextDocValuesWriter.MINVALUE;
import static trycodec.SimpleTextDocValuesWriter.NUMVALUES;
import static trycodec.SimpleTextDocValuesWriter.ORDPATTERN;
import static trycodec.SimpleTextDocValuesWriter.PATTERN;
import static trycodec.SimpleTextDocValuesWriter.TYPE;
...
class SimpleTextDocValuesReader extends DocValuesProducer {
  ...
  public NumericDocValues getNumeric(FieldInfo fieldInfo) throws IOException {
    final IntFunction<Long> values = getNumericNonIterator(fieldInfo);
    if (values == null) {
      return null;
    } else {
      final DocValuesIterator docsWithField = getNumericDocsWithField(fieldInfo);
  ...
  public synchronized BinaryDocValues getBinary(FieldInfo fieldInfo) throws IOException {
    ...
    final DocValuesIterator docsWithField = getBinaryDocsWithField(fieldInfo);

    final IntFunction<BytesRef> values =
